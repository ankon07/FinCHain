...
class CrossBorderCard extends StatefulWidget {
  final String label;
  ...
  @override
  State<CrossBorderCard> createState() => _CrossBorderCardState();
}

class _CrossBorderCardState extends State<CrossBorderCard> {
  @override
